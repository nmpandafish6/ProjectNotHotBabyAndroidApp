...
import com.cecs490.pnhb.projectnothotbabyfinal.R;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stats = StatisticsHelper.getDewPointStatistics();
        ...
        stats = StatisticsHelper.getMTTRStatistics();
        ResourceMaster.statistics_high_mttr.setText(String.format("%1.1f min",stats.max));
        ResourceMaster.statistics_average_mttr.setText(String.format("%1.1f min",stats.mean));
        ResourceMaster.statistics_low_mttr.setText(String.format("%1.1f min",stats.min));
