    ...
    public static void init(){
        ...
        Thread waitForReadyThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final BluetoothDevice blueDevice = BluetoothHelper.mblue.getRemoteDevice(ResourceMaster.preferences.getString(Constants.BLUETOOTH_MAC_KEY,"Dummy Addr"));
                ...
                ResourceMaster.m_activity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            }else if(!ResourceMaster.myDevice.mDevice.getAddress().equals(ResourceMaster.preferences.getString(Constants.BLUETOOTH_MAC_KEY,"Dummy Addr"))) {
                                ResourceMaster.myDevice.disconnect();
                                Log.e("BLUETOOTH_TAG", "Connecting to " + bluetoothMAC);
                                ResourceMaster.myDevice = new BluetoothHelper(blueDevice, blueBehavior);
                            }else {
                ...
                Thread reconnectThread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        while(reconnect){
                            ...
                            if(!ResourceMaster.myDevice.getIsConnected()){
                                Log.e("BLUETOOTH_TAG", "Connecting to " + bluetoothMAC);
                                ResourceMaster.m_activity.runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
